...
- `docs/rules/logging-standards.md`: Logging rules for unified format, `trace_id`, levels, safe parameters, exception stack traces, Java SLF4J usage, sensitive-data masking, async/performance, structured search, and monitoring.
